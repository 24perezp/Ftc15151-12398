...
double Speed  = .8*gamepad1.left_stick_y;
double Turn  = .8*gamepad1.left_stick_x;
...
telemetry.addData("daniel sucks d", flmspeed);
...
if (gamepad2.right_trigger==1){
         ...
         lslide.setTargetPosition(lslide.getCurrentPosition()+100);
